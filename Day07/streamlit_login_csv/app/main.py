...
def init_session_state() -> None:
    '''
    Streamlit 은 버튼 클릭 이나 입력시 스크립트를 다시 실행함.
...
def load_users() -> pd.DataFrame:
    ...
    if not require_columns.issubset(user_df.columns):
