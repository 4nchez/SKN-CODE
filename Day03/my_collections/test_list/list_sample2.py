# path : my_collections/test_list/list_sample2.py
...
# remove() : 지정한 element를 제거함. 갯수 줄어듦
# 리스트변수.remove(제거할 element)
def list_remove():
    lst.remove(20)
    print(f'after : {lst}')
    print(f'after : {len(lst)}')
    
    # 제거할 element가 여러 개인 경우
